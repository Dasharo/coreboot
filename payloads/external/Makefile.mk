...
$(obj)/UEFIPAYLOAD.fd: $(DOTCONFIG) $(IPXE_EFI)
	$(MAKE) -C payloads/external/edk2 DasharoPayloadPkg \
		...
		GCC_IA32_PREFIX=$(patsubst %gcc,%,$(GCC_CC_x86_32)) \
		GCC_X64_PREFIX=$(patsubst %gcc,%,$(GCC_CC_x86_64)) \
		GCC_ARM_PREFIX=$(patsubst %gcc,%,$(GCC_CC_arm)) \
		GCC_AARCH64_PREFIX=$(patsubst %gcc,%,$(GCC_CC_arm64)) \
		MFLAGS= MAKEFLAGS= \
		...
		CONFIG_EDK2_DASHARO_INTEL_ME_CBNT_STATUS=$(CONFIG_EDK2_DASHARO_INTEL_ME_CBNT_STATUS) \
		...
		CONFIG_EDK2_CAPSULE_DOES_NOT_SURVIVE_RESET=$(CONFIG_EDK2_CAPSULE_DOES_NOT_SURVIVE_RESET) \
		CONFIG_EDK2_CAPSULE_ON_DISK_SIZE=$(call _tohex, $(call int-divide, $(call int-multiply, $(CONFIG_ROM_SIZE) 3) 2)) \
