...
# FIXME
# Dasharo release 0.x compatible with Dell OptiPlex
GPG_FINGERPRINT="190C87AA1B343268D276"

BOARD="dell_optiplex_9010"
...
LOGO="3rdparty/dasharo-blobs/dasharo/evaluation_logo.bmp"
SDKVER="2022-04-04_9a8d0a03db"
REPLACE_KEYS=0
...
upload() {
  ...
  then
    REMOTE_DIR="/projects/3mdeb/Dasharo/releases/dell_optiplex_9010/${FW_VERSION}"
    FILES="${ARTIFACTS_DIR}/*"
