...
printf "#define DASHARO_VERSION \"%s\"\n" `git describe --tags --match "msi_ms7d25_v[0-9]*.[0-9]*.[0-9]*" | sed 's/msi\_ms7d25\_//' | sed 's/\(v[0-9]\.[0-9]\.[0-9]\+\).*/\1/'`
printf "#define DASHARO_MAJOR_VERSION %d\n#define DASHARO_MINOR_VERSION %d\n#define DASHARO_PATCH_VERSION %d\n" `git describe --tags --match "msi_ms7d25_v[0-9]*.[0-9]*.[0-9]*" | sed 's/msi\_ms7d25\_//' | sed 's/v\([0-9]\)\.\([0-9]\)\.\([0-9]\+\).*/\1 \2 \3/'`
