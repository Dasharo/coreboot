...
ifeq ($(CONFIG_UEFI_2_4_BINDING)$(CONFIG_USE_UEFI_2_4_BINDING),y)
...
else ifeq ($(CONFIG_UDK_2017_BINDING)$(CONFIG_USE_UDK_2017_BINDING),y)
...
else ifeq ($(CONFIG_UDK_202005_BINDING)$(CONFIG_USE_UDK_202005_BINDING),y)
...
else ifeq ($(CONFIG_UDK_202111_BINDING)$(CONFIG_USE_UDK_202111_BINDING),y)
...
else ifeq ($(CONFIG_UDK_202302_BINDING)$(CONFIG_USE_UDK_202302_BINDING),y)
