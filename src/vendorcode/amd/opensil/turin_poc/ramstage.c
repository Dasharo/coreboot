...
static void setup_rc_manager_default(void)
{
	...
	/*
	 * MmioAbove4GLimit will be adjusted down in OpenSIL. Use 46 bits,
	 * since we do not use 5-level paging in coreboot nor UEFI Payload yet
	 * to cover whole space. Also the maximum address bits under Xen is 46
	 * on Turin systems.
	 */
...
static void configure_usb(void)
{
	...
	usb_config.Version_Major = 0xD;
	usb_config.Version_Minor = 0x13;
...
static void configure_fch_acpi(void)
{
	...
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i2c_0))->enabled ? BIT(5) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i2c_1))->enabled ? BIT(6) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i2c_2))->enabled ? BIT(7) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i2c_3))->enabled ? BIT(8) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i2c_4))->enabled ? BIT(9) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i2c_5))->enabled ? BIT(10) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(uart_0))->enabled ? BIT(11) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(uart_1))->enabled ? BIT(12) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(uart_2))->enabled ? BIT(16) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i3c_0))->enabled ? BIT(21) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i3c_1))->enabled ? BIT(13) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i3c_2))->enabled ? BIT(14) : 0);
	fch_data->FchRunTime.FchDeviceEnableMap |= ((DEV_PTR(i3c_3))->enabled ? BIT(15) : 0);
