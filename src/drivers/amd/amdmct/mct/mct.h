...
/* j loop constraint. 1 = CL 2.0 T */
#define J_MIN		0
/* j loop constraint. 4 = CL 6.0 T */
#define J_MAX		4
/* k loop constraint. 1 = 200 MHz */
#define K_MIN		1
/* k loop constraint. 9 = 400 MHz */
#define K_MAX		4
/* Default value for failsafe operation. 2 = CL 4.0 T */
#define CL_DEF		2
...
struct DCTStatStruc {		/* A per Node structure*/
	...
	u8 err_code;	/* Current error condition of Node
				   0= no error
				   1= Variance Error, DCT is running
				      but not in an optimal configuration.
...
//	u8 reserved_b_2;	/*Reserved*/
	...
	u8 ch_b_dqs[2][2][9];	/* CHA Byte 0 - 7 and Check Write DQS Delay*/
				...
				/* Reserved*/
	u8 ch_d_rcvr_dly[2][4];	/* CHA DIMM 0 - 3 Receiver Enable Delay*/
...
void get_channel_ps_cfg_0(unsigned int maa_dimms, unsigned int speed, unsigned int maa_load,
		unsigned int data_a_load, unsigned int *addr_tmg_ctl, unsigned int *odc_ctl);
