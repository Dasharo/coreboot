...
#define _PCI_DEV(slot, func)	pcidev_on_root(slot, func)
#else
#include <arch/io.h>
...
#define XHCI_PCIDEV		_PCI_DEV(XHCI_DEV, XHCI_FUNC)

#define XHCI2_DEV		0x10
#define XHCI2_FUNC		1
#define XHCI2_DEVID		0x7814
#define XHCI2_DEVFN		PCI_DEVFN(XHCI2_DEV, XHCI2_FUNC)
#define XHCI2_PCIDEV		_PCI_DEV(XHCI2_DEV, XHCI2_FUNC)
...
#define SATA_PCIDEV		_PCI_DEV(SATA_DEV, SATA_FUNC)
...
#define OHCI1_PCIDEV		_PCI_DEV(OHCI1_DEV, OHCI1_FUNC)
#define OHCI2_PCIDEV		_PCI_DEV(OHCI2_DEV, OHCI2_FUNC)
#define OHCI3_PCIDEV		_PCI_DEV(OHCI3_DEV, OHCI3_FUNC)
#define OHCI4_PCIDEV		_PCI_DEV(OHCI4_DEV, OHCI4_FUNC)
...
#define EHCI1_PCIDEV		_PCI_DEV(EHCI1_DEV, EHCI1_FUNC)
#define EHCI2_PCIDEV		_PCI_DEV(EHCI2_DEV, EHCI2_FUNC)
#define EHCI3_PCIDEV		_PCI_DEV(EHCI3_DEV, EHCI3_FUNC)
...
#define SMBUS_PCIDEV		_PCI_DEV(SMBUS_DEV, SMBUS_FUNC)
...
#define IDE_PCIDEV		_PCI_DEV(IDE_DEV, IDE_FUNC)
#endif
...
#define HDA_PCIDEV		_PCI_DEV(HDA_DEV, HDA_FUNC)
...
#define LPC_PCIDEV		_PCI_DEV(LPC_DEV, LPC_FUNC)
...
#define SB_PCI_PORT_PCIDEV	_PCI_DEV(SB_PCI_PORT_DEV, SB_PCI_PORT_FUNC)
...
#define SD_PCIDEV		_PCI_DEV(SD_DEV, SD_FUNC)
...
#define SB_PCIE_PORT1_PCIDEV	_PCI_DEV(SB_PCIE_DEV, SB_PCIE_PORT1_FUNC)
#define SB_PCIE_PORT2_PCIDEV	_PCI_DEV(SB_PCIE_DEV, SB_PCIE_PORT2_FUNC)
#define SB_PCIE_PORT3_PCIDEV	_PCI_DEV(SB_PCIE_DEV, SB_PCIE_PORT3_FUNC)
#define SB_PCIE_PORT4_PCIDEV	_PCI_DEV(SB_PCIE_DEV, SB_PCIE_PORT4_FUNC)
#endif
