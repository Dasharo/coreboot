...
#if !IS_ENABLED(CONFIG_CPU_AMD_PI_00730F01)
//
// FT3B doesn't support OHCI
//
...
/* EHCI */
#if IS_ENABLED(CONFIG_CPU_AMD_PI_00730F01)
// FT3B has EHCI on function 0
#define EHCI1_FUNC 0
#define EHCI2_FUNC 0
#define EHCI3_FUNC 0
#else //IS_ENABLED(CONFIG_CPU_AMD_PI_00730F01)
#define EHCI1_FUNC 2
#define EHCI2_FUNC 2
#define EHCI3_FUNC 2
#endif //IS_ENABLED(CONFIG_CPU_AMD_PI_00730F01)
...
#if IS_ENABLED(CONFIG_CPU_AMD_PI_00730F01)
#define SB_PCIE_DEV 0x2
#define SB_PCIE_PORT0_FUNC 1
#define SB_PCIE_PORT1_FUNC 2
#define SB_PCIE_PORT2_FUNC 3
#define SB_PCIE_PORT3_FUNC 4
#define SB_PCIE_PORT4_FUNC 5
#define SB_PCIE_PORT1_DEVID 0x1439
#define SB_PCIE_PORT2_DEVID 0x1439
#define SB_PCIE_PORT3_DEVID 0x1439
#define SB_PCIE_PORT4_DEVID 0x1439
#define SB_PCIE_PORT5_DEVID 0x1439
#define SB_PCIE_PORT1_DEVFN PCI_DEVFN(SB_PCIE_DEV,SB_PCIE_PORT1_FUNC)
#define SB_PCIE_PORT2_DEVFN PCI_DEVFN(SB_PCIE_DEV,SB_PCIE_PORT2_FUNC)
#define SB_PCIE_PORT3_DEVFN PCI_DEVFN(SB_PCIE_DEV,SB_PCIE_PORT3_FUNC)
#define SB_PCIE_PORT4_DEVFN PCI_DEVFN(SB_PCIE_DEV,SB_PCIE_PORT4_FUNC)
