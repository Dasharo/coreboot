 ...
 * 8.2 host_setup_sbe
 *
 * - Done for all boots - some settings will change based on system type and IPL
 *   type
 * - Set the GP bits to default state
 * - Needs to take into account to not change values set up in
 *   p9_set_clock_term.C procedure
 */
