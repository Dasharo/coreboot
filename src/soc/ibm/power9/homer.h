...
#define QUAD_SCOM_RESTORE_SIZE_PER_QUAD	\
	(SCOM_RESTORE_ENTRY_SIZE * QUAD_SCOM_RESTORE_REGS_PER_QUAD)
#define CORE_SCOM_RESTORE_REGS_PER_CORE	16
#define CORE_SCOM_RESTORE_SIZE_PER_CORE	\
	(SCOM_RESTORE_ENTRY_SIZE * CORE_SCOM_RESTORE_REGS_PER_CORE)
...
struct cpmr_header {
	...
	uint32_t quad_pstate_offset[MAX_QUADS_PER_CHIP];
