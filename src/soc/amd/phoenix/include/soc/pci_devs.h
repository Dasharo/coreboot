...
/* PCIe GFX/GPP Bridge device 1 with 4 ports (5 ports on AM5) */
...
#define PCIE_GPP_1_5_FUNC	5
#define PCIE_GPP_1_5_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_1_DEV, PCIE_GPP_1_5_FUNC)
#define SOC_GPP_1_5_DEV		_SOC_DEV(PCIE_GPP_BRIDGE_1_DEV, PCIE_GPP_1_5_FUNC)
...
/* PCIe GPP Bridge device 3 and 4 for USB4 */
#define PCIE_GPP_BRIDGE_3_DEV	0x3

#define PCIE_USB4_3_1_FUNC	1
#define PCIE_USB4_3_1_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_USB4_3_1_FUNC)
#define SOC_PCIE_USB4_3_1_DEV	_SOC_DEV(PCIE_GPP_BRIDGE_3_DEV, PCIE_USB4_3_1_FUNC)

#define PCIE_GPP_BRIDGE_4_DEV	0x4

#define PCIE_GPP_4_1_FUNC	1
#define PCIE_USB4_4_1_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_4_DEV, PCIE_USB4_4_1_FUNC)
#define SOC_PCIE_USB4_4_1_DEV	_SOC_DEV(PCIE_GPP_BRIDGE_4_DEV, PCIE_USB4_4_1_FUNC)
