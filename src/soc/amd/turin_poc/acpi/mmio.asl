...
Device (GPIO)
{
	...
	Method (_CRS, 0) {
		Local0 = ResourceTemplate() {
			...
			Memory32Fixed (ReadWrite, ACPIMMIO_RGPIO_BASE, 0x2C)
		}
...
Device (FUR0)
{
	...
	Method (_CRS, 0) {
		Local0 = ResourceTemplate() {
			...
			Memory32Fixed (ReadWrite, APU_DMA0_BASE, 0x1000)
		}
		CreateDWordField (Local0, IRQR._INT, IRQN)
		If (PICM) {
			IRQN = IUA0
...
Device (FUR1) {
	...
	Method (_CRS, 0) {
		Local0 = ResourceTemplate() {
			...
			Memory32Fixed (ReadWrite, APU_DMA1_BASE, 0x1000)
		}
		CreateDWordField (Local0, IRQR._INT, IRQN)
		If (PICM) {
			IRQN = IUA1
...
Device (FUR2) {
	...
	Method (_CRS, 0) {
		Local0 = ResourceTemplate() {
			...
			Memory32Fixed (ReadWrite, APU_DMA2_BASE, 0x1000)
		}
		CreateDWordField (Local0, IRQR._INT, IRQN)
		If (PICM) {
			IRQN = IUA2
...
Device (FUR3) {
	...
	Method (_CRS, 0) {
		Local0 = ResourceTemplate() {
			...
			Memory32Fixed (ReadWrite, APU_DMA3_BASE, 0x1000)
		}
		CreateDWordField (Local0, IRQR._INT, IRQN)
		If (PICM) {
			IRQN = IUA3
