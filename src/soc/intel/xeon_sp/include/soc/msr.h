 ...
 * Taking the "save state in MSRs" path in
 * soc/intel/common/block/cpu/smmrelocate.c therefore #GPs inside the SMM
 * relocation handler, which has no IDT, and the platform dies.
 */
