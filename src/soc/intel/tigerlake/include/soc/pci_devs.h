...
#define  SA_DEVFN_PEG1		_SA_DEVFN(PEG, 0)
#define  SA_DEVFN_PEG2		_SA_DEVFN(PEG, 1)
#define  SA_DEVFN_PEG3		_SA_DEVFN(PEG, 2)
...
#define  SA_DEVFN_CPU_PCIE	_SA_DEVFN(CPU_PCIE, 0)
