...
static const struct {
	...
	{ MC_CTL_MASK(1), AMD_OR_B2, AMD_PTYPE_ALL,
			1 << 18, 0x00000000,
	...
	{ MC_CTL_MASK(1), AMD_OR_C0, AMD_PTYPE_ALL,
			1 << 15, 0x00000000,
	...
	{ MC_CTL_MASK(4), (AMD_FAM10_ALL | AMD_FAM15_ALL), AMD_PTYPE_ALL,
			0xF << 19, 0x00000000,
...
static const struct {
	...
	{ 3, 0x64, (AMD_FAM10_ALL | AMD_FAM15_ALL), AMD_PTYPE_ALL,
		0x0A4C0001, 0xF080FFFE },	/* [27:24] HtcHystLmt = 0xa, (5 degrees)
						* [22:16] HtcTmpLmt = 0x4c, (90 degrees)
						* [0] HTCEn = 1
						*/
