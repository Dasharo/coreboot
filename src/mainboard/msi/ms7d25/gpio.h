...
static const struct pad_config gpio_table[] = {
	...
	/* GPP_B15 - GPIO - SYSFAN5_MODE */
	PAD_CFG_GPO(GPP_B15, 0, PLTRST),
	/* GPP_B16 - GPIO - SYSFAN6_MODE */
	PAD_CFG_GPO(GPP_B16, 0, PLTRST),
	/* GPP_B17 - GPIO - I225_PGD1 */
	...
	/* GPP_G0 - GPIO - TBT_FORCE_PWR */
	PAD_CFG_GPO(GPP_G0, 0, PLTRST),
	/* GPP_G1 - GPIO - TBT_RTD3_PWR_EN */
	...
	/* GPP_G7 - GPIO - TBT_CIO_PLUG_EVENT# */
	PAD_NC(GPP_G7, NONE),
	...
	/* GPP_H20 - GPIO - DEVICE EZ LED */
	PAD_CFG_GPO(GPP_H20, 0, PLTRST),
	/* GPP_H21 - GPIO - CPU EZ LED */
	PAD_CFG_GPO(GPP_H21, 0, PLTRST),
	/* GPP_H22 - GPIO - DRAM EZ LED */
	PAD_CFG_GPO(GPP_H22, 0, PLTRST),
	/* GPP_H23 - GPIO - VGA EZ LED */
	...
	/* GPP_K3 - GPIO - TBT_S0IX_ENTRY_ACK */
	PAD_CFG_GPI_TRIG_OWN(GPP_K3, NONE, PLTRST, OFF, ACPI),
	/* GPP_K4 - GPIO - TBT_S0IX_ENTRY_REQ */
	...
	/* GPP_F22 - GPIO - TBT_PSON_PVERRIDE# */
...
/* Nuvoton NCT6687D pins:
 * pin15:  GPIO80 - TBT_CARD_DET#
 * pin28:  GPIO12 - CUT_VBAT
 * pin37:  GPIO74 - CLR_CMOS
 * pin38:  GPIO30 - ALL_LED_OFF#
 * pin39:  GPIO31 - M2_PLN#
 * pin51:  GPIO44 - M2_BT_LED#
 * pin71:  GPEN07 - S0_IDLE
 * pin72:  GPIO06 - SIO_WAKE#
 * pin74:  GPIO95 - LED_VSB
 * pin77:  GPEN13 - PLTRST_BU3# to SPI TPM, i225
 * pin78:  GPEN12 - PLTRST_BU2# to M2 slots
 * pin79:  GPEN11 - PLTRST_BU1# to PCIe slots
 * pin82:  GPEN15 - SLP_S0#
 * pin83:  GPEN05 - PCH_PSON#
 * pin90:  GPIO91 - SIO_MSCL0 to PCH SMBUS and JSMB1
 * pin91:  GPIO92 - SIO_MSDA0 to PCH SMBUS and JSMB1
 * pin92:  GPIO86 - USB_MODE (default high - USB pwr S0/S3, low - USB pwr S0/S3/S5)
 * pin93:  GPIO90 - LED_VCC
 * pin118: GPIO87 - RTCRST_DET#
 * pin123: GPIO76 - MCU_SMB_SDA to JDASH1
 * pin128: GPIO75 - MCU_SMB_SCL to JDASH1
 */
 ...
 *    IT8851: TBD
 *    RT3628: 0x42
 *    DIMM PMIC: 0x90, 0x92, 0x94, 0x96
 */


/* RT3628 dump coreboot:

    00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f
00: 04 04 04 04 04 04 04 04 ff ff ff ff ff ff ff ff 
10: 00 00 00 00 00 00 00 00 ff ff ff ff ff ff ff ff 
20: 06 06 07 00 00 83 00 5f 00 00 00 ff ff ff ff ff 
30: 22 00 ff ff ff ff ff ff ff ff ff ff ff ff ff 00 
40: 06 06 07 00 00 83 00 5f 00 00 00 ff ff ff ff ff 
50: 06 e3 5b 91 ca 1f 00 ff ff ff ff ff ff ff ff ff 
60: 1f 79 c7 11 00 ff ff ff ff ff ff ff ff ff ff ff 
70: 01 ff ff f6 00 00 00 00 00 2b 22 1f 3f ff ff 00 
80: 0b 07 12 13 0b 03 14 00 a5 ac 32 34 34 32 39 31 
90: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff 
a0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff 
b0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff 04 09 
c0: 08 20 1d 11 bb b4 9c 12 8a fd 83 60 96 c6 89 6e 
d0: 9e 87 a7 63 b1 ca e2 c0 34 2d 1c 35 e5 ff ec 5d 
e0: 97 af 20 44 4c 32 c7 06 01 0a 1c 13 13 1f e4 8c 
