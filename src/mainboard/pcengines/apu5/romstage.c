...
static const GPIO_CONTROL gGpioInitTable[] = {
		...
		GPIO_DEFINITION (APU5_SIMSWAP1_GPIO,   APU5_SIMSWAP1_FUNC,   1, 0, 0, 0),
// SPKR doesn't require init, left at default
		GPIO_DEFINITION (APU5_PROCHOT_GPIO,    APU5_PROCHOT_FUNC,    0, 0, 0, 0),
		GPIO_DEFINITION (APU5_SIMSWAP2_GPIO,   APU5_SIMSWAP2_FUNC,   1, 0, 0, 0),
		GPIO_DEFINITION (APU5_SIMSWAP3_GPIO,   APU5_SIMSWAP3_FUNC,   1, 0, 0, 0),
