...
/*
 * This code was auto-generated using extract.rs from
 * https://github.com/system76/smart-amp
 */
...
int tas5825m_setup(struct device *dev, int id)
{
	...
	{
		const uint8_t values[] = {
			0x00, 0x03, 0x69, 0xC5, 0x00, 0xFE, 0x16, 0xD5,
	...
	{
		const uint8_t values[] = {
			0x7F, 0xF9, 0x2C, 0x60, 0x04, 0x90, 0xB5, 0x11,
			0x00
		};
		res = tas5825m_write_block_at(dev, 0x5C, values, ARRAY_SIZE(values));
		if (res < 0)
	...
	{
		const uint8_t values[] = {
			0x07, 0xF6, 0x71, 0xFB, 0xF0, 0x5E, 0x48, 0xD6,
			0x07, 0xAC, 0xA4, 0x5B, 0x0F, 0xA1, 0xB7, 0x2A,
			0xF8, 0x5C, 0xE9, 0xAA, 0x08, 0x00, 0x00, 0x00,
			0xF0, 0xBC, 0xDB, 0x13, 0x07, 0x4B, 0x87, 0x16,
			0x0F, 0x43, 0x24, 0xED, 0xF8, 0xB4, 0x78, 0xEA,
			0x08, 0x00, 0x00, 0x00, 0xF1, 0x2E, 0x37, 0x44,
			0x06, 0xE6, 0xAE, 0x6C, 0x0E, 0xD1, 0xC8, 0xBC,
			0xF9, 0x19, 0x51, 0x94, 0x08, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00
		};
...

	{
		const uint8_t values[] = {
			...
			0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x07, 0xE3, 0xB6, 0x0E,
			0xF0, 0x38, 0x93, 0xE5, 0x07, 0xE3, 0xB6, 0x0E,
			0x0F, 0xC7, 0x37, 0xC3, 0xF8, 0x38, 0x5F, 0x8D,
			0x00
		};
		res = tas5825m_write_block_at(dev, 0x08, values, ARRAY_SIZE(values));
		if (res < 0)
	...
	{
		const uint8_t values[] = {
			0x07, 0xE7, 0xF3, 0x30, 0xF0, 0x30, 0x19, 0xA1,
			0x07, 0xE7, 0xF3, 0x30, 0x0F, 0xCF, 0xB1, 0xEB,
			0xF8, 0x2F, 0xE5, 0x2D, 0x07, 0xEF, 0xD5, 0xCD,
			0xF0, 0x20, 0x54, 0x66, 0x07, 0xEF, 0xD5, 0xCD,
			0x0F, 0xDF, 0x76, 0xF1, 0xF8, 0x20, 0x1F, 0xBE,
			0x07, 0xF8, 0xC3, 0x5E, 0xF0, 0x17, 0xB1, 0xEA,
			0x07, 0xEF, 0xAD, 0x9B, 0x0F, 0xE8, 0x4E, 0x16,
			0xF8, 0x17, 0x8F, 0x07, 0x08, 0x06, 0x13, 0x6A,
			0xF0, 0x0B, 0x9D, 0x15, 0x07, 0xEE, 0x72, 0x7F,
			0x0F, 0xF4, 0x3F, 0x7D, 0xF8, 0x0B, 0x56, 0xA9,
			0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...

	{
		const uint8_t values[] = {
			...
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x07, 0xE3, 0xB6, 0x0E, 0xF0, 0x38, 0x93, 0xE5,
			0x07, 0xE3, 0xB6, 0x0E, 0x0F, 0xC7, 0x37, 0xC3,
			0xF8, 0x38, 0x5F, 0x8D, 0x07, 0xE7, 0xF3, 0x30,
			0xF0, 0x30, 0x19, 0xA1, 0x07, 0xE7, 0xF3, 0x30,
			0x0F, 0xCF, 0xB1, 0xEB, 0xF8, 0x2F, 0xE5, 0x2D,
			0x07, 0xEF, 0xD5, 0xCD, 0xF0, 0x20, 0x54, 0x66,
			0x07, 0xEF, 0xD5, 0xCD, 0x0F, 0xDF, 0x76, 0xF1,
			0xF8, 0x20, 0x1F, 0xBE, 0x07, 0xF8, 0xC3, 0x5E,
			0xF0, 0x17, 0xB1, 0xEA, 0x07, 0xEF, 0xAD, 0x9B,
			0x0F, 0xE8, 0x4E, 0x16, 0xF8, 0x17, 0x8F, 0x07,
			0x00
		};
		res = tas5825m_write_block_at(dev, 0x08, values, ARRAY_SIZE(values));
		if (res < 0)
	...
	{
		const uint8_t values[] = {
			0x08, 0x06, 0x13, 0x6A, 0xF0, 0x0B, 0x9D, 0x15,
			0x07, 0xEE, 0x72, 0x7F, 0x0F, 0xF4, 0x3F, 0x7D,
			0xF8, 0x0B, 0x56, 0xA9, 0x08, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00
		};
	...
	{
		const uint8_t values[] = {
			0x00, 0x82, 0xB3, 0xD2, 0xFF, 0x00, 0xA4, 0x7A,
			0x00, 0x7C, 0xCA, 0xB8, 0x0F, 0xF6, 0xBE, 0xFB,
			0xF8, 0x09, 0x1E, 0x02, 0x00
		};
		res = tas5825m_write_block_at(dev, 0x6C, values, ARRAY_SIZE(values));
		if (res < 0)
			return res;
	...
	res = tas5825m_write_at(dev, 0x4C, 0x40);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x01, 0x09);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x06, 0x00);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x06, 0x40);
	if (res < 0)
		return res;
	...
	res = tas5825m_set_page(dev, 0xC0);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x02, 0xFE);
	if (res < 0)
		return res;

	res = tas5825m_set_page(dev, 0xD0);
	if (res < 0)
		return res;
	...
	res = tas5825m_set_page(dev, 0xE0);
	if (res < 0)
		return res;
	...
	res = tas5825m_set_page(dev, 0xF0);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x03, 0xFE);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x48, 0x00);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x0D, 0x33);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x44, 0x33);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x0C, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x1E, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x2E, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x3A, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x45, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x51, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x57, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x78, 0x36);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x63, 0x37);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x62, 0x38);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x21, 0x3A);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x27, 0x3A);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x33, 0x3A);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x38, 0x3A);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x79, 0x3A);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x1C, 0x3B);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x25, 0x3B);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x2F, 0x3B);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x39, 0x3B);
	if (res < 0)
		return res;

	res = tas5825m_set_page(dev, 0x3F);
	if (res < 0)
		return res;
	...
	res = tas5825m_set_page(dev, 0x20);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x0C, 0x00);
	if (res < 0)
		return res;
	...
	res = tas5825m_write_at(dev, 0x13, 0x39);
	if (res < 0)
		return res;

	res = tas5825m_write_at(dev, 0x21, 0x39);
	if (res < 0)
		return res;
