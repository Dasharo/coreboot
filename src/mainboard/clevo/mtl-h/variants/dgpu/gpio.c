...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_GPI_TRIG_OWN(GPP_A17, NONE, PLTRST, LEVEL, ACPI),	/* GPIO */
	...
	PAD_CFG_GPI_TRIG_OWN(GPP_F12, NONE, DEEP, OFF, ACPI),	/* GPIO */
	PAD_CFG_GPI_TRIG_OWN(GPP_F13, NONE, DEEP, OFF, ACPI),	/* GPIO */
