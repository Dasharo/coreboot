...
/* Pad configuration was generated automatically using intelp2m 1.1-8ad1ee9b0ad5 */
static const struct pad_config gpio_table[] = {
	...
	PAD_NC(GPP_H21, NONE),
	PAD_NC(GPP_H22, NONE),
	_PAD_CFG_STRUCT(GPP_H23, PAD_FUNC(NF2) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_D8, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | (1 << 1), 0),
	...
	PAD_NC(GPP_F17, NONE),
	PAD_NC(GPP_F18, NONE),
	_PAD_CFG_STRUCT(GPP_F19, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | (1 << 1), 0),
	...
	PAD_NC(GPP_E12, NONE),
	PAD_NC(GPP_E13, NONE),
	_PAD_CFG_STRUCT(GPP_E14, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | (1 << 1), PAD_IOSSTATE(TxDRxE)),
	...
	_PAD_CFG_STRUCT(GPP_E22, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | (1 << 1), PAD_PULL(DN_20K) | PAD_IOSSTATE(IGNORE)),
