...
static const struct pad_config gpio_table[] = {
	...
	/* DW0: (1 << 1) - IGNORED */
	/* PAD_CFG_GPI_SCI(GPP_E13, NONE, DEEP, LEVEL, INVERT), */
	_PAD_CFG_STRUCT(GPP_E13, PAD_RESET(DEEP) | PAD_IRQ_ROUTE(SCI) | PAD_RX_POL(INVERT) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_E20, NATIVE, DEEP, NF1), */
	...
	/* DW0: 0x44000702, DW1: 0x0001fc00 */
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | (1 << 1) - IGNORED */
	/* PAD_CFG_NF(GPP_E21, NATIVE, DEEP, NF1), */
