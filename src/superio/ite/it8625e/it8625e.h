...
static const uint8_t IT8625E_EC_HIGH_TEMP_LIMIT[] = { 0x40, 0x42, 0x44, 0x46, 0xb4, 0xb6 };
static const uint8_t IT8625E_EC_LOW_TEMP_LIMIT[]  = { 0x41, 0x43, 0x45, 0x47, 0xb5, 0xb7 };
