...
EOF
    ...
    yes | openssl ca -extensions v3_ca -in sub.csr -days 3650 -cert root.pub.pem -keyfile root.p8e -notext -out sub.pub.pem
    ...
    yes | openssl ca -in sign.csr -days 3650 -cert sub.pub.pem -keyfile sub.p8e -out sign.crt
