...
# verification will fail
	...
	@printf "    BOOTBLOCK\n"
	$(CBFSTOOL) $@.tmp add -r $(BB_FIT_REGION) $(bootblock_add_params)
	@printf "    TOPSWAP\n"
	$(CBFSTOOL) $@.tmp add -r $(TS_FIT_REGION) $(bootblock_add_params)
...
$(call add_intermediate, copy_cbfs_metadata_from_bb_to_ts, $(CBFSTOOL))
	$(CBFSTOOL) $< extract -r $(BB_FIT_REGION) -n bootblock -f $(obj)/bootblock-metadata.tmp
	$(CBFSTOOL) $< remove  -r $(TS_FIT_REGION) -n bootblock
	$(CBFSTOOL) $< add     -r $(TS_FIT_REGION) $(bootblock_add_params) -f $(obj)/bootblock-metadata.tmp
endif
